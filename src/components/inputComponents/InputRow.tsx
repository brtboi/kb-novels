...
const InputRow = React.forwardRef<HTMLInputElement, Props>(
   (
      { row, state, handleOnFocus, handleOnBlur, handleOnClick, handleKeyDown },
      ref
   ) => {
      return (
         <div
            className={classNames(styles.InputRow, {
               [styles.hide]: state === STATE.HIDE || state === STATE.DISABLE,
            })}
         >
